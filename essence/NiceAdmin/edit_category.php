              ...
              <div class="panel-body">
                <div class="form">
                  ...
                  while ($row = mysqli_fetch_row($querySid)) {
                    $checked = "";
                    if($row[2] == 1){
                      $checked = $checked.'<input class="form-control " id="cemail" type="checkbox" name="checkbox" value ="1" checked />';
                    }else{
                      $checked = $checked.'<input class="form-control " id="cemail" type="checkbox" name="checkbox" value ="1"  />';
                    }
                    $id = $row[0];
                    echo '
                  ...
                  <form class="form-validate form-horizontal" id="feedback_form" method="post" action="">
                    ...
                    <div class="form-group ">
                      <label for="cemail" class="control-label col-lg-2">Tên loại <span class="required">*</span></label>
                      <div class="col-lg-10">
                    ...
                    <div class="form-group ">
                      <label for="cemail" class="control-label col-lg-2">Show menu <span class="required">*</span></label>
                      <div class="col-lg-10">
                        '.$checked.'
                      </div>
                    </div>
